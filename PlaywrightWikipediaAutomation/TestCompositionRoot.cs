using PlaywrightWikipediaAutomation.Extensions;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;

namespace PlaywrightWikipediaAutomation;
    ...
    public static IServiceProvider BuildServiceProvider(IConfiguration configuration)
    {
        ...
        services.AddHttpClient<Api.IMediaWikiApiClient, Api.MediaWikiApiClient>()
            .ConfigureHttpClient((sp, client) =>
            {
                ...
                client.DefaultRequestHeaders.UserAgent.ParseAdd("PlaywrightWikipediaAutomation/1.0 (Automation Test Suite)");
            });
